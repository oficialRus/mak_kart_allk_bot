...
type DailyNumberScreenProps = {
  ...
  dailyNumberDescription: string | null;
  ...
  return (
    <main className="page">
      ...
      <div className="page-inner">
              ...
              {hasResult && (
                <div className="result-text">
                  ...
                  <p className="result-description">
                    {dailyNumberDescription ?? "Описание дня формируется..."}
                  </p>
                  {dailyMessage && (
        ...
        {hasResult && dailyAffirmation ? (
          <section className="roulette-card">
            <div className="daily-affirmation-text">
              <div className="daily-affirmation-text__title">Пожелание на день</div>
              <div className="daily-affirmation-text__body">{dailyAffirmation}</div>
            </div>
          </section>
        ) : null}
